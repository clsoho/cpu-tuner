...
impl Profile {
    ...
    pub fn preset_extreme() -> Self {
        Self {
            id: 4,
            name: "\u{6781}\u{81f4}\u{6027}\u{80fd}".to_string(),
            icon: "\u{1F5A5}\u{FE0F}".to_string(),
            power_plan_guid: Some("8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c".to_string()),
            min_processor_state: Some(100),
            max_processor_state: Some(100),
            system_cooling_policy: Some(1),
